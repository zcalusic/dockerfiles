...
DOCKER_IMAGE ?= zcalusic/rest-server-builder
...
docker_build:
	docker pull golang:1.9.1-stretch
	docker build \
...
docker_push:
	...
	curl -X POST https://hooks.microbadger.com/images/zcalusic/rest-server-builder/xzGFGXy_eQRvnnXSufHCh-iViGs=
	@echo
